...
*/
#define RING_BUFFER_SIZE 2097152
 ...
 */
void ring_buffer_queue_arr(ring_buffer_t *buffer, unsigned char *data, unsigned int size);
 ...
 */
uint8_t ring_buffer_dequeue_arr(ring_buffer_t *buffer, unsigned char *data, unsigned int len);
/**
